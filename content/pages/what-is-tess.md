  ...
  <div class="accordion-item">
    ...
    <div id="collapseObjectives" class="accordion-collapse collapse" aria-labelledby="headingObjectives" data-bs-parent="#accordionWhereIsTESS" style="">
      <div class="accordion-body">
        ...
        <br>
          <img class="img-responsive" style="max-width:67%;" src="images/articles/tess_bright_stars.png">
  ...
  <div class="accordion-item">
    ...
    <div id="collapseLaunch" class="accordion-collapse collapse" aria-labelledby="headingLaunch" data-bs-parent="#accordionWhereIsTESS" style="">
      <div class="accordion-body">
        ...
        <br>
          <img class="img-responsive" style="max-width:75%;" src="images/articles/tess_launch_shots.jpg"></img>
        ...
        <br>
          <img class="img-responsive" style="max-width:75%;align-content:center" src="images/articles/tess_orbit_Winnpresentation.jpg"></img>
    ...
    <div id="collapseOperations" class="accordion-collapse collapse" aria-labelledby="headingOperations" data-bs-parent="#accordionWhereIsTESS" style="">
      <div class="accordion-body">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a class="nav-link" data-bs-toggle="tab" href="#em2" aria-selected="false" tabindex="-1" role="tab">Second Extension</a>
          </li>       
        </ul>
        <div id="myTabContent" class="tab-content">
          <div class="tab-pane fade in show active" id="primary" role="tabpanel">
            <p>
             ...
             <br>When the cameras were shifted north, the northern ecliptic pole was located 7 degrees from the center of Camera 3, and the southernmost edge of Camera 1 was at an ecliptic latitude of ~37 degrees. In addition, with this shift, the fields-of-view of Cameras 3 and 4 observed "on the other side of the pole'', thereby providing additional observations of parts of the sky that would otherwise only be observed in Sectors 20-22. </br>
              ...
              <img class="img-responsive" style="max-width:30%;" src="images/articles/tess_sky_coverage.png">
              </br>
              ...
              <br>
                <img class="img-responsive" style="max-width:90%;" src="images/articles/y1sec.png">
                <img class="img-responsive" style="max-width:90%;" src="images/articles/y2sec.png">
              </b>
              <br>
                <img class="img-responsive" style="max-width:90%;" src="images/articles/tess_first_light_quarter.jpg"></img><figcaption>Above: The first light image from TESS, showing the combined view of all four of its cameras taken on August 7, 2018.</figcaption><figcaption> Image Credit: NASA/MIT/TESS</figcaption>
             </br>
           </p>
          </div>
          <div class="tab-pane fade in" id="em1" role="tabpanel">
            <p>
              ...
              <br>
                ...
                <img class="img-responsive" style="max-width:90%;" src="images/articles/Cycle3sectors.png">
              ...
              <br>
                <img class="img-responsive" style="max-width:90%;" src="images/articles/Cycle3table.png">
              ...
              <br>
                <img class="img-responsive" style="max-width:90%;" src="images/articles/Cycle4sectors.png">
              ...
              <br/>
              <br>
                <img class="img-responsive" style="max-width:90%;" src="images/articles/Cycle4table.png">
          ...
          <div class="tab-pane fade in" id="em2" role="tabpanel">
            <p>
              ...
              <br>
                <img class="img-responsive" style="max-width:45%;" src="images/articles/Year5_cel.png">
                <img class="img-responsive" style="max-width:45%;" src="images/articles/Year5_ecl.png">
              ...
              <br>
                <img class="img-responsive" style="max-width:45%;" src="images/articles/Year6_cel.png">
                <img class="img-responsive" style="max-width:45%;" src="images/articles/Year6_ecl.png">
  ...
  <div class="accordion-item">
    ...
    <div id="collapseEngage" class="accordion-collapse collapse" aria-labelledby="headingEngage" data-bs-parent="#accordionWhereIsTESS" style="">
      <div class="accordion-body">
          ...
          <br>
            <img class="img-responsive" style="max-width:100%;" src="images/articles/engage_with_tess.png">
            <figcaption>Image Credit: MIT</figcaption>
          </br>
      </div>
    </div>
