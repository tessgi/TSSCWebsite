...
\begin{itemize}
    ...
    \item PIs are required to upload a one-page \href{https://heasarc.gsfc.nasa.gov/docs/tess/docs/proposal-templates/tessgi\_teamexpertise\_template\_Cycle9.pdf}{Team Expertise} PDF through a separate upload when submitting the science justification into ARK/RPS.
...
Proposals to this joint program must clearly justify the need for \swift\ data and the amount of \swift\ time needed to achieve the science goals.\\

These proposals must also present a defined plan for analysis of both the TESS and \swift\ data.\\
...
Questions about OSDMPs can be sent to SARA@nasa.gov or the program scientist Josh Pepper (joshua.a.pepper@nasa.gov).
